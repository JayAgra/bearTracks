...
function submit() {
    ...
    cycle_data.push({ score_type: 9, intake: Number((document.querySelector("[name=park]") as HTMLInputElement).checked), travel: Number((document.querySelector("[name=trap_note]") as HTMLInputElement).checked), outtake: Number((document.querySelector("[name=trap_note]") as HTMLInputElement).checked) });
    cycle_data.push({ score_type: 10, intake: Number((document.querySelector("[name=shallow_cage]") as HTMLInputElement).checked), travel: Number((document.querySelector("[name=climb]") as HTMLInputElement).checked), outtake: Number((document.querySelector("[name=climb]") as HTMLInputElement).checked) });
    cycle_data.push({ score_type: 11, intake: Number((document.querySelector("[name=buddy_climb]") as HTMLInputElement).checked), travel: Number((document.querySelector("[name=buddy_climb]") as HTMLInputElement).checked), outtake: Number((document.querySelector("[name=buddy_climb]") as HTMLInputElement).checked) });
    cycle_data.push({ score_type: 14, intake: Number((document.querySelector("[name=auto_algae]") as HTMLInputElement).checked), travel: Number((document.querySelector("[name=auto_neutral]") as HTMLInputElement).checked), outtake: Number((document.querySelector("[name=auto_neutral]") as HTMLInputElement).checked) });
    cycle_data.push({ score_type: 15, intake: Number((document.querySelector("[name=auto_coral]") as HTMLInputElement).checked), travel: Number((document.querySelector("[name=auto_wing]") as HTMLInputElement).checked), outtake: Number((document.querySelector("[name=auto_wing]") as HTMLInputElement).checked) });
