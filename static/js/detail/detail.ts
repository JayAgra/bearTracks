...
async function loadData() {
    ...
    _get(`/api/v1/data/detail/${submissionID}`, errElement.id).then((listRes) => {
        ...
        (document.getElementById("resultTeamNum") as HTMLElement).innerText = data.team;
        (document.getElementById("resultMatchNum") as HTMLElement).innerText = data.match_num;
        (document.getElementById("resultEventCode") as HTMLElement).innerText = data.event;
