 ...
 */
export declare type APIAuditLogChangeKeyImageHash = AuditLogChangeData<'image_hash', string>;
/**
 ...
 */
export declare type APIAuditLogChangeKeyNick = AuditLogChangeData<'nick', string>;
/**
 ...
 */
export declare type APIAuditLogChangeKeyEntityType = AuditLogChangeData<'entity_type', GuildScheduledEventEntityType>;
/**
 * Returned when status of a guild scheduled event is changed
 */
export declare type APIAuditLogChangeKeyStatus = AuditLogChangeData<'status', GuildScheduledEventStatus>;
/**
 * Returned when location of a guild scheduled event is changed
 */
export declare type APIAuditLogChangeKeyLocation = AuditLogChangeData<'location', string>;
/**
 * Returned when a user's timeout is changed
 */
export declare type APIAuditLogChangeKeyCommunicationDisabledUntil = AuditLogChangeData<'communication_disabled_until', string>;
