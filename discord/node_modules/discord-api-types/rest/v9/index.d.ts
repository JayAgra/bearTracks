...
export declare const Routes: {
     ...
     */
    threads(parentId: Snowflake, messageId?: string | undefined): `/channels/${string}/threads` | `/channels/${string}/messages/${string}/threads`;
    /**
     * Route for:
     ...
     */
    channelThreads(channelId: Snowflake, archived?: "public" | "private" | undefined): `/channels/${string}/threads/archived/public` | `/channels/${string}/threads/archived/private` | `/channels/${string}/threads/active`;
    /**
     * Route for:
     ...
     */
    threadMembers(threadId: Snowflake, userId?: string | undefined): `/channels/${string}/thread-members` | `/channels/${string}/thread-members/${string}`;
    /**
     * Route for:
     * - GET   `/users/@me`
     * - GET   `/users/{user.id}`
     ...
     */
    webhook(webhookId: Snowflake, webhookToken?: string | undefined): `/webhooks/${string}` | `/webhooks/${string}/${string}`;
    /**
     * Route for:
