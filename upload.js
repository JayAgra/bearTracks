    ...
    req.on('end', () => {
      ...
      formEmitter.on('formType', () => {
        if (formData.formType == 'pit') {
            ...
            let stmt = `INSERT INTO main (event, name, game1, game2, game3, game4, game5, game6, game7, game8, game9, game10, game11, game12, game13, game14, game15, game16, game17, game18, game19, game20, confidence, bqual, overall, scoutIP) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
