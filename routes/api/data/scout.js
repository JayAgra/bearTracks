function getScoutResponses(req, res, db, season) {
    const stmt = "SELECT id, team, match, level, game2, game3, game4, game5, game6, game7, game8, game10, game25, game11, weight, discordID, discordName, discordTag FROM main WHERE season=? AND discordID=? ORDER BY id DESC";
