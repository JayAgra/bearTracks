...
export async function teamsByEvent(req: express.Request, res: express.Response, db: sqlite3.Database, season: number) {
    const stmt: string = `SELECT match, game13, game14, game15, game16, game17, game18, game19, game20, game21, game23, game24, game25, weight FROM main WHERE team=? AND event=? AND season=?`;
