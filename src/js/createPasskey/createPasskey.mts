...
const elemBegin = document.getElementById("createPk") as HTMLButtonElement;
const elemSuccess = document.getElementById("success") as HTMLHeadingElement;
const elemError = document.getElementById("error") as HTMLHeadingElement;
