...
fn season_2024(data: &web::Json<db_main::MainInsert>) -> Result<AnalysisResults, Error> {
    ...
    for time in &game_data {
        match time.score_type {
            ...
            5 => auto_center = time.intake as i64,
            6 => auto_wing = time.intake as i64,
            7 => auto_preload = time.intake as i64,
    ...
    let mps_scores: Vec<f64> = vec![score, fast_intake, fast_travel, fast_shoot, fast_cycle];
